...
import com.gmail.foodde.adapter.CategoryVerticalAdapter;
...
public class GetVerticalCategories extends AsyncTask<String, Void, String> {
    ...
    public GetVerticalCategories(Context context, List<Category> categoryList, RecyclerView recyclerView, RecyclerView itemsView){
    ...
    private void setCategoryRecycler(List<Category> categoryList) {
        ...
        CategoryVerticalAdapter categoryAdapter = new CategoryVerticalAdapter(context, categoryList, itemsView);
